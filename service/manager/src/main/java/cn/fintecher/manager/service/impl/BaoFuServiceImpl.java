...
import cn.fintecher.manager.service.BaoFuService;
import cn.fintecher.util.DoubleUtils;
import cn.fintecher.util.baofu.TransContent;
import cn.fintecher.util.baofu.TransHead;
import cn.fintecher.util.baofu.domain.RequestParams;
import cn.fintecher.util.baofu.http.SimpleHttpResponse;
import cn.fintecher.util.baofu.request.TransReqBF0040001;
import cn.fintecher.util.baofu.request.TransReqBF0040002;
import cn.fintecher.util.baofu.response.TransRespBF0040001;
import cn.fintecher.util.baofu.response.TransRespBF0040002;
import cn.fintecher.util.baofu.response.TransRespBF40001Async;
import cn.fintecher.util.baofu.rsa.RsaCodingUtil;
import cn.fintecher.util.baofu.util.*;
...
public class BaoFuServiceImpl  implements BaoFuService {
    ...
    public static Map ApiPay(Map map) throws Exception{
        ...
        String  txn_amt = String.valueOf(DoubleUtils.mul(DoubleUtils.keepSpace(map.get("debitAmount").toString()), 100d).intValue());//支付金额转换成分
