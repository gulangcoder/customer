...
import cn.fintecher.manager.model.SysEntOtherConfig;
import cn.fintecher.manager.model.SysOtherConfig;
import cn.fintecher.manager.service.SysEntOtherConfigService;
import cn.fintecher.manager.service.SysOtherConfigService;
...
//    public ResponseEntity updateOther(@RequestBody SysOtherConfig sysOtherConfig){
...
//        if(!flag){
//            return ResponseEntity.badRequest().headers(HeaderUtil.createAlert(map.get("msg").toString(),ENTITY_NAME)).body(null);
//        }
//        return ResponseEntity.ok().headers(HeaderUtil.createAlert(map.get("msg").toString(),ENTITY_NAME)).body(null);
//    }
    /**
     * 修改状态
...
//    }
    ...
    public ResponseEntity saveOtherConfig(@RequestBody Map data){
        //解析请求参数
        //获取用户信息
        UserInfo userInfo = UserContextUtil.getUserInfo();
    ...
    public ResponseEntity updateOtherConfig(@RequestBody Map data){
        //解析参数
        //用户信息
        UserInfo userInfo = UserContextUtil.getUserInfo();
    ...
    public ResponseEntity getOtherConfigInfo(@RequestParam(value = "id") String id){
        try {
...
//    public ResponseEntity getOtherConfigList(){
//        List<SysOtherConfig> otherConfigs = sysOtherConfigService.getOtherConfigList(new HashMap());
//        return ResponseEntity.ok().header("find success",ENTITY_NAME).body(otherConfigs);
//    }
    ...
    public ResponseEntity getCompanyConfigList(@RequestParam(value = "companyCode") String companyCode){
        ...
        return ResponseEntity.ok().body(ResponseLogMessageHandel.initSuccessResponseData(returnList));
    }
