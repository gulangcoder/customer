...
import cn.fintecher.manager.service.SysModuleService;
...
public class SysModuleController {
    ...
    public ResponseEntity getModuleInfo(@RequestParam(value = "sysCode") String sysCode){
        try {
            SysModule sysModule = sysModuleService.getModuleInfo(sysCode);
            return ResponseEntity.ok().body( ResponseLogMessageHandel.initSuccessResponseData(sysModule));
        }catch (Exception e){
            String localeTipMsg = LocaleMessage.get("message.query.errorMessage");
    ...
    public ResponseEntity getModuleMenuListBySysCode(@RequestParam(value = "sysCode") String sysCode){
        try {
            List<Map> moduleMenuList = sysModuleDetailService.getModuleMenuListBySysCode(sysCode);
            return ResponseEntity.ok().body(ResponseLogMessageHandel.initSuccessResponseData(moduleMenuList));
        }catch (Exception e){
            String localeTipMsg=LocaleMessage.get("message.query.errorMessage");
