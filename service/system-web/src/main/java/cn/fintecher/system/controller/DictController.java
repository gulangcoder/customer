...
import cn.fintecher.system.model.DictDetail;
import cn.fintecher.system.model.DictItem;
import cn.fintecher.system.service.DictDetailService;
import cn.fintecher.system.service.DictItemService;
import cn.fintecher.system.start.DictCacheLoader;
...
//
    ...
    public ResponseEntity getDictItemList(@RequestParam(value = "pageSize") Integer pageSize,
    ...
    public ResponseEntity updateDictItemStatus(@RequestBody Map data){
        if(null==data.get("id")||StringUtil.isEmpty(data.get("id").toString())){
            return ResponseEntity.badRequest().header("传参异常",ENTITY_NAME).body(null);
        }
    ...
    public ResponseEntity getDictItemById(@RequestParam("id") String id){
        try {
            DictItem dictItem = dictItemService.getDictItemById(id);
            return ResponseEntity.ok().body(ResponseLogMessageHandel.initSuccessResponseData(dictItem));
        }catch (Exception e){
            String logmsg = LocaleMessage.get("message.query.errorMessage");
    ...
    public ResponseEntity saveDictItem(@RequestBody DictItem dictItem){
        UserInfo userInfo = UserContextUtil.getUserInfo();
    ...
    public ResponseEntity updateDictItem(@RequestBody DictItem dictItem){
    ...
    public ResponseEntity updateDictDetailStatus(@RequestBody Map data){
    ...
    public ResponseEntity getDictDetailById(@RequestParam("id") String id){
        try {
            ...
            return ResponseEntity.ok().body(ResponseLogMessageHandel.initSuccessResponseData(dictDetail));
        }catch (Exception e){
            String logmsg = LocaleMessage.get("message.query.errorMessage");
    ...
    public ResponseEntity saveDictDetail(@RequestBody DictDetail dictDetail){
        //创建人
    ...
    public ResponseEntity updateDictDetail(@RequestBody DictDetail dictDetail){
        //修改人
