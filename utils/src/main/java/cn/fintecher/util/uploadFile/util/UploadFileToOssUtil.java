package cn.fintecher.util.uploadFile.util;
...
public class UploadFileToOssUtil {
     ...
     * @throws Exception
     */
    public static Map<String, Object> getFileOss(HttpServletRequest request, String saveDir, String fileName, String dir, String bucketName, String endpoint, String accessKeyId, String accessKeySecret) throws Exception {
        ...
        if (formItems != null && formItems.size() > 0) {
            ...
            for (FileItem item : formItems) {
                ...
                if (!item.isFormField()) {
                    ...
                    item.write(file);
                    String appUrl = appOss(file,dir,bucketName, endpoint, accessKeyId, accessKeySecret);
                    fileModel.put("originalName", item.getName());
                    fileModel.put("file", file);
     ...
     * @return: Map
     */
    public static Map uploadToOSS(Map<String , String> srcMap, String imgPath, String dir, String bucketName, String endpoint, String accessKeyId, String accessKeySecret) throws Exception {
        //解密
        Map<String , String> photoMap = new HashMap<String , String>();
        BASE64Decoder decoder = new BASE64Decoder();
        for(Map.Entry<String , String> entry : srcMap.entrySet()){
     ...
     * @return: Map
     */
    public static Map uploadVIdeoToOSS(Map<String , String> srcMap, String imgPath, String dir, String bucketName, String endpoint, String accessKeyId, String accessKeySecret) throws Exception {
        //解密
        Map<String , String> photoMap = new HashMap<String , String>();
        BASE64Decoder decoder = new BASE64Decoder();
        for(Map.Entry<String , String> entry : srcMap.entrySet()){
