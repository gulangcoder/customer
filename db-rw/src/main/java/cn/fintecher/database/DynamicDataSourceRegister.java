...
public class DynamicDataSourceRegister implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    private void dataBinder(DataSource dataSource, Environment env){
        ...
        if(dataSourcePropertyValues == null){
            Map<String, Object> rpr = new RelaxedPropertyResolver(
                    env, "spring.datasource.hikari").getSubProperties(".");
    ...
    public PlatformTransactionManager writeTransactionManager() {
        System.err.println("writeTransactionManager=========配置主数据库的事务");
        return new DynamicDataSourceTransactionManager(defaultDataSource);
    }
    @Bean
    public PlatformTransactionManager readTransactionManager() {
        System.err.println("readTransactionManager=========配置从数据库的事务");
        return new DynamicDataSourceTransactionManager(customDataSources.get(DynamicDataSourceGlobal.DATA_READ_TYPE));
    }
}
